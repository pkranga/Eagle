...
@Component({
  selector: 'ws-player-toc',
  templateUrl: './player-toc.component.html',
  styleUrls: ['./player-toc.component.scss']
})
export class PlayerTocComponent implements OnInit, OnChanges {
  @Input() toc: IContent;
