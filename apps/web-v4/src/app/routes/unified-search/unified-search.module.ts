...
import { MatListModule, MatTooltipModule, MatChipsModule, MatMenuModule } from '@angular/material';
...
import { UnifiedSearchRoutingModule } from './unified-search-routing.nodule';
...
import { KhubGoModule } from '../../routes/khub-go/khub-go.module';
import { SearchResultsSocialComponent } from './components/search-results-social/search-results-social.component';
...
@NgModule({
  declarations: [
    ...
    SearchCardComponent,
    SearchResultsSocialComponent,
    QandaCardComponent,
    BlogsCardComponent
  ],
  imports: [
    CommonModule,
    UnifiedSearchRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatToolbarModule,
    MatInputModule,
