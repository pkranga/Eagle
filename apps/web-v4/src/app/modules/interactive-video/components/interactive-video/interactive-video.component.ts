...
import { Subscription, timer, interval, fromEvent } from 'rxjs';
import { tap, map, first } from 'rxjs/operators';
import { TelemetryService } from '../../../../services/telemetry.service';
import { ValuesService } from '../../../../services/values.service';
import { HistoryService } from '../../../../services/history.service';
import { IVideoPluginTelemetry, ICommEvent, COMM_STATES, TDataError } from '../../../../models/comm-events.model';
...
export class InteractiveVideoComponent implements OnInit, OnDestroy {
  ...
  async ngOnInit() {
    if (this.processedContent && this.processedContent.content && this.processedContent.interactions) {
      this.interactionMarkersTimeSet = new Set(this.processedContent.interactions.interactions.map(interaction => interaction.time));
