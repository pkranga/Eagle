...
export class TrainingShareDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TrainingShareDialogComponent>,
  ...
  onBtnShareClick() {
    ...
    const nominateSubsription = this.trainingsSvc.shareTraining(this.offering.offering_id, emails).subscribe(
      () => {
