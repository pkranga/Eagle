...
public class KafkaConsumerConfig {
    ...
    @Value("${kafka.autOffsetResetConfig}")
    private String autOffsetResetConfig;
    ...
    private Map<String, Object> consumerConfigs() {
        ...
        propsMap.put(ConsumerConfig.GROUP_ID_CONFIG, "manual-es-replication-group");
        propsMap.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, autOffsetResetConfig);
        return propsMap;
