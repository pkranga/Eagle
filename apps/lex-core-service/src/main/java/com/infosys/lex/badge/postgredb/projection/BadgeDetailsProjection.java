...
public interface BadgeDetailsProjection {
	...
	public Optional<BigDecimal> getthreshold1();

	public Optional<Integer> gettimePeriod();

	public Optional<Integer> getthreshold2();
	...
	public Optional<String> getbadgeGroupText();
