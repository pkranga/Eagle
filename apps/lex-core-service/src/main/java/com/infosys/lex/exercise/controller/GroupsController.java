...
public class GroupsController {
	...
	public ResponseEntity<Map<String, Object>> getAllGroups(@PathVariable("educator_id") String educatorId,
			@RequestHeader(name = "rootOrg",required = false,defaultValue = JsonKey.INFOSYS_ROOTORG)String rootOrg)
			throws Exception {
		
		Map<String, Object> resp = new HashMap<String, Object>();
		List<Map<String, String>> rep = exerciseServ.getEducatorGroups(rootOrg,educatorId);
		resp.put("groups", rep);
