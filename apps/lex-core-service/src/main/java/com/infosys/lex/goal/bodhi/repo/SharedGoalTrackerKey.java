...
@PrimaryKeyClass
public class SharedGoalTrackerKey implements Serializable {
	...
	@PrimaryKeyColumn(name = "shared_by", ordinal = 1, type = PrimaryKeyType.PARTITIONED)
	...
	@PrimaryKeyColumn(name = "shared_with", ordinal = 4, type = PrimaryKeyType.CLUSTERED)
