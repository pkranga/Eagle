...
public class HealthController {
	...
	/**
	 * gets the health or working status for the application, sb-ext, content store, cassandra, elastic and mongo
	 * @return
	 * @throws Exception
	 */
	@GetMapping("/_health")
	public ResponseEntity<Map<String, Object>> testHealth() throws Exception {
