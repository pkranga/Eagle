...
public class NewCodeExerciseDTO implements Serializable {

	private static final long serialVersionUID = 1L;

	@NotNull(message = "{exercise.result_percent.mandatory}")
	private Float result_percent;

	@NotNull(message = "{exercise.total_testcases.mandatory}")
	private Integer total_testcases;

	@NotNull(message = "{exercise.testcases_passed.mandatory}")
	private Integer testcases_passed;

	@NotNull(message = "{exercise.testcases_failed.mandatory}")
	...
	public String toString() {
		return "NewCodeExerciseDTO [result_percent=" + result_percent + ", total_testcases=" + total_testcases
