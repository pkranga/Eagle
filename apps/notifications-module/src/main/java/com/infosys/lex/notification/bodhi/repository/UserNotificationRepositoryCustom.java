...
public interface UserNotificationRepositoryCustom {
	...
	NotificationSendDTO getNotificationsBySeen(String rootOrg, String userId, String page, Integer size,
			String classification, Boolean showUnseen) throws Exception;
