...
public class SearchConstants {
	...
	public static final String IS_CATALOG = "catalog";
	...
	public static final String FILTER_SOURCE_SHORT_NAME_RAW_FIELD_KEY = "sourceShortName.raw";
	...
	public static final String FILTER_KEYWORDS_RAW_FIELD_KEY = "keywords.raw";
...
//		aggAndFilterNamesMap.put(UNIT_AGGS_KEY,FIELD_DISPLAYNAME_PAIR.get(UNIT_AGGS_KEY));
//		aggAndFilterNamesMap.put(IS_EXTERNAL_AGGS_KEY,FIELD_DISPLAYNAME_PAIR.get(IS_EXTERNAL_AGGS_KEY));
//		aggAndFilterNamesMap.put(JOB_PROFILE_AGGS_KEY,FIELD_DISPLAYNAME_PAIR.get(JOB_PROFILE_AGGS_KEY));
