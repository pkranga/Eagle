...
import com.infosys.search.decorators.OrgsDecorator;
...
@Component("AdminMultiLingualIntegratedSearchService")
//@Validated
class AdminMultiLingualIntegratedSearchService extends MultiLingualIntegratedSearchService {

	@Autowired
	private MultiLingualIntegratedSearchValidator validator;
	
    @Autowired
    private OrgsDecorator orgsDecorator;
