...
//@Component("GeneralMultiLingualIntegratedSearchService")
@Service("GeneralMultiLingualIntegratedSearchService")
public class GeneralMultiLingualIntegratedSearchService extends MultiLingualIntegratedSearchService {
    ...
    private Response callSuperSearchService(ValidatedSearchData validatedSearchData) throws Exception {
